...
weather_template = [
    lambda c: f"a photo of {c}, a type of weather phenomena"
]

vegetable_template = [
    lambda c: f"a photo of {c}, a type of vegetable"
]

mangoleafbd_template = [
    lambda c: f"a photo of {c} mango leaf"
]

landscape_template = [
    lambda c: f"a photo of {c} landscape",
    lambda c: f"a scenic view of the {c}",
    lambda c: f"a natural {c} scene",
    lambda c: f"a beautiful {c} environment",
    lambda c: f"a picture showing the {c}",
]

beans_template = [
    lambda c: f"a photo of {c} bean plant leaf"
]

intel_images_template = [
    lambda c: f"a natural scene depicting {c}",
    lambda c: f"a photo of {c}"
]

garbage_classification_template = [
    lambda c: f"a photo of {c}, a type of garbage"
]

kvasir_template = [
    lambda c: f"an endoscopic image showing {c}",
    lambda c: f"a medical image of {c} inside the gastrointestinal tract",
    lambda c: f"an endoscopy photo depicting {c}",
    lambda c: f"a clinical finding of {c} in a GI tract image",
    lambda c: f"a medical endoscopy scene showing {c}",
]

kenyanfood13_template = [
    lambda c: f"an image of {c}, a Kenyan food type"
]

dogs_template = [
    lambda c: f"a photo of a {c}",
    lambda c: f"an image of a {c} dog",
    lambda c: f"a dog of breed {c}",
    lambda c: f"a {c} in a natural setting",
    lambda c: f"a close-up photo of a {c}",
    lambda c: f"a picture of a {c} dog breed",
]
...
dataset_to_template = {
    ...
    "Vegetables": vegetable_template,
    "MangoLeafBD": mangoleafbd_template,
    "Landscapes": landscape_template,
    "Beans": beans_template,
    "IntelImages": intel_images_template,
    "Garbage": garbage_classification_template,
