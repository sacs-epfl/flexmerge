...
from NLP.eval.utils import prepare_batchOfEvalInfo, getAndMake_specificPredictionDir
from NLP.eval.cache import getCached_predictions, does_cachePredictionExist
from NLP.eval.Evaluator import Evaluator
...
def evaluate_model(
    ...
    if is_nodeZero(device):
        ...
        ### Commenting this out to disable the cache
